...
import 'package:flutter_spareparts_store/features/wishlist/domain/model/wishlist_model.dart';
...
import 'package:flutter_spareparts_store/basewidget/remove_from_wishlist_bottom_sheet.dart';
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(children: [
                        Expanded(child: Text(wishlistModel?.productFullInfo?.details ?? '',maxLines: 1,overflow: TextOverflow.ellipsis,
                            style: titilliumSemiBold.copyWith(color: ColorResources.getReviewRattingColor(context),
                                fontSize: Dimensions.fontSizeDefault))),
                      ]),
                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                        ...
                        Row(children: [
                          ...
                          InkWell(onTap: (){
                            ...
                            child: Container(height: 40,
                              ...
                              child: Icon(Icons.list_alt_rounded, color: Theme.of(context).primaryColor, size: 25),
                            ),
                          ),
                        ],
                        ),

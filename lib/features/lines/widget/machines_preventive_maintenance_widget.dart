...
class MachinePreventiveMaintenanceWidget extends StatefulWidget {
  final MaintenanceList? machineMaintenanceList;
  final bool? isExpanded;
  final UniqueKey? keyTile;
  const MachinePreventiveMaintenanceWidget(
      {super.key, this.machineMaintenanceList,required this.isExpanded, required this.keyTile});

  @override
  State<MachinePreventiveMaintenanceWidget> createState() =>
      _MachinePreventiveMaintenanceWidgetState();
}

class _MachinePreventiveMaintenanceWidgetState extends State<MachinePreventiveMaintenanceWidget> {
              ...
              child: Column(children: [
                    Card(
                      ...
                      child: ExpansionTile(
                        ...
                        title: Text(widget.machineMaintenanceList!.assemblyCode!),
                        subtitle: Text(widget.machineMaintenanceList!.assemblyDescription!),
                        children: [
                          Padding(
                            padding: const EdgeInsets.symmetric(
                          ...
                          Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: widget.machineMaintenanceList!.assemblymaintenanceitems!.length,
                                ...
                                return Column(children: [
                                  Row(children: [
                                    ...
                                    SizedBox(
                                      width: 90,
                                      child: Text(
                                        widget.machineMaintenanceList!.assemblymaintenanceitems![index].partCode!,
                                        overflow: TextOverflow.ellipsis,
                                        style: ubuntuRegularLow.copyWith(
                                    ...
                                    SizedBox(
                                        ...
                                        child: Row(children: [
                                          InkWell(
                                            onTap: () async {
                                              final res = await http.get(Uri.parse(
                                                  '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.productImageUrl}/${widget.machineMaintenanceList!.assemblymaintenanceitems![index].partCode}.webp'));
                                                ...
                                                await showDialog(
                                                    ...
                                                    builder: (_) =>
                                                        MachineEmergencyImagePop(
                                                            image:
                                                                '${widget.machineMaintenanceList!.assemblymaintenanceitems![index].partCode}.webp',
                                                            url: Provider.of<
                                                                        SplashProvider>(
                                                                    context,
                                                                    listen:
                                          ...
                                          Expanded(
                                            child: Text(
                                              '${widget.machineMaintenanceList!.assemblymaintenanceitems![index].materialDescription}',
                                              maxLines: 2,
                                              overflow: TextOverflow.ellipsis,
                                              style: ubuntuRegularLow.copyWith(
                                                  color: Theme.of(context)
                                  ...
                                  Row(children: [
                                    ...
                                    SizedBox(
                                      width: 50,
                                      child: Text(
                                        "${widget.machineMaintenanceList!.assemblymaintenanceitems![index].quantity}",
                                        overflow: TextOverflow.ellipsis,
                                        style: ubuntuRegularLow.copyWith(
                                            color:
                                                Theme.of(context).primaryColor),
                                    ...
                                    SizedBox(
                                      width: 50,
                                      child: Text(
                                        "${widget.machineMaintenanceList!.assemblymaintenanceitems![index].uom}",
                                        overflow: TextOverflow.ellipsis,
                                        style: ubuntuRegularLow.copyWith(
                                            color:
                                                Theme.of(context).primaryColor),

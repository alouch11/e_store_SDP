class ConfigModel {
  ...
  String ? packagelines;
  String ? packagehours;
  String ? packagemachines;
  String ? orderLinesFilter;
  String ? orderMachinesFilter;
  String ? orderPersonsFilter;
  String ? orderTypesFilter;
  String ? orderSuppliersFilter;
  String ? serviceLinesFilter;
  String ? serviceMachinesFilter;
  String ? servicePersonsFilter;
  String ? serviceTypesFilter;
  List<LinesMachines>? linesMachines;
  String ? nfcEnable;
  ...
  ConfigModel(
      {this.brandSetting,
        ...
        this.packagelines,
        this.packagehours,
        this.packagemachines,
        this.orderLinesFilter,
        this.orderMachinesFilter,
        this.orderPersonsFilter,
        this.orderTypesFilter,
        this.orderSuppliersFilter,
        this.serviceLinesFilter,
        this.serviceMachinesFilter,
        this.servicePersonsFilter,
        this.serviceTypesFilter,
        this.linesMachines,
        this.nfcEnable,
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
   ...
   // userAppVersion = json['user_app_version_control'];

    packagelines = json['package_lines'];
    packagehours = json['package_hours'];
    packagemachines = json['package_machines'];

    orderLinesFilter = json['order_line_filter'];
    orderMachinesFilter = json['order_machine_filter'];
    orderPersonsFilter = json['order_person_filter'];
    orderTypesFilter = json['order_type_filter'];
    orderSuppliersFilter = json['order_supplier_filter'];

    serviceLinesFilter = json['service_line_filter'];
    serviceMachinesFilter = json['service_machine_filter'];
    servicePersonsFilter = json['service_person_filter'];
    serviceTypesFilter = json['service_type_filter'];


    if (json['lines_machines'] != null) {
      linesMachines = <LinesMachines>[];
      json['lines_machines'].forEach((v) {
        linesMachines!.add(LinesMachines.fromJson(v));
      });
    }

    nfcEnable= json['nfc_enable'];
...
class BaseUrls {
  ...
  String? machineDataUrl;
  String? machineCataloguesUrl;
  String? serviceImagesUrl;
  String? appsUrl;
  String? threeDModelsUrl;
  //String? machineImagesUrl;
  ...
  BaseUrls(
      {this.productImageUrl,
        ...
        this.machineDataUrl,
        this.machineCataloguesUrl,
        this.serviceImagesUrl,
        this.appsUrl,
        this.threeDModelsUrl,
        //this.machineImagesUrl,
      });
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    graphicImageUrl = json['graphic_image_url'];
    machineDataUrl = json['machine_data_url'];
    machineCataloguesUrl = json['machine_catalogues_url'];
    serviceImagesUrl = json['service_images_url'];
    appsUrl = json['apps_url'];
    threeDModelsUrl = json['threedmodels_url'];
    //machineImagesUrl = json['machine_images_url'];
  }
...
class LinesMachines {
 ...
 String? machines;
  ...
  LinesMachines({this.name, this.machines});

  LinesMachines.fromJson(Map<String, dynamic> json) {
    name = json['name'];

...
class NotificationServiceScreenUnread extends StatefulWidget {

  const NotificationServiceScreenUnread({super.key, });
  @override
  State<NotificationServiceScreenUnread> createState() => _NotificationServiceScreenUnreadState();
}

class _NotificationServiceScreenUnreadState extends State<NotificationServiceScreenUnread> {
  ScrollController scrollController = ScrollController();

  @override
   initState(){
        Provider.of<NotificationProvider>(context, listen: false).getNotificationList(1,'external');
        Provider.of<NotificationProvider>(context, listen: false).notificationType='external';
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Consumer<NotificationProvider>(
        builder: (context, notification, child) {
          ...
          RefreshIndicator(
            onRefresh: () async {
              await Provider.of<NotificationProvider>(context, listen: false).getNotificationList(1,'external');
            },
            child:

...
class ProductDataImageScreen extends StatefulWidget {
  final String? title;
  final String? imagePath;
  final List<String>? imageList;
  final  bool? machineParameters;
  const ProductDataImageScreen({super.key, required this.title, required this.imagePath, required this.imageList, this.machineParameters});

  @override
  ProductDataImageScreenState createState() => ProductDataImageScreenState();
}

class ProductDataImageScreenState extends State<ProductDataImageScreen> {
  int? pageIndex;
  PageController? _pageController;

  //bool? machineParameters;


  @override
  void initState() {
    super.initState();
    if(widget.machineParameters == true) {
      pageIndex = Provider.of<MachinesProvider>(context, listen: false).imageSliderIndex;
    } else {
              ...
              PhotoViewGallery.builder(
                ...
                builder: (BuildContext context, int index) {
                  return PhotoViewGalleryPageOptions(
                    imageProvider: NetworkImage('${Provider.of<SplashProvider>(context,listen: false).baseUrls!.machineDataUrl}/'
                        '${widget.imagePath}'

...
class SearchRepo {
  ...
  Future<ApiResponse> getSearchProductList(String query, String? searchtype,String? categoryIds, String? brandIds, String? sort, String? priceMin, String? priceMax, int offset) async {
    try {
      final response = await dioClient!.post(AppConstants.searchUri,
          data: {
        'search' : base64.encode(utf8.encode(query)),
            'search_type': searchtype??'byitem',

...
import 'package:flutter_spareparts_store/basewidget/rating_bar.dart';
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Container(width: sellerIconSize,height: sellerIconSize,
                    ...
                    child: ClipRRect(borderRadius: BorderRadius.circular(sellerIconSize),
                      child: CustomImage(image: '${Provider.of<SplashProvider>(context,listen: false).baseUrls!.sellerImageUrl}/${seller.sellerModel!.seller!.image}'))),

...
import 'package:flutter_spareparts_store/features/home/shimmer/recommended_product_shimmer.dart';
...
/*                                  recommended.recommendedProduct !=null && recommended.recommendedProduct!.thumbnail !=null?
                                  Container(width: 135,
                                    ...
                                    height: (recommended.recommendedProduct!.currentStock! < recommended.recommendedProduct!.minimumOrderQuantity!)? 170:150,
                                    decoration: BoxDecoration(
...
/*                                          if(recommended.recommendedProduct!.currentStock! < recommended.recommendedProduct!.minimumOrderQuantity! && recommended.recommendedProduct!.productType == 'physical' && seeqty== 'yes')
                                      ...
                                      //  const SizedBox(height: Dimensions.paddingSizeSmall,),
                                       ...
                                       //     PriceConverter.convertPrice(context, recommended.recommendedProduct!.unitPrice),
                                        ...
                                        const SizedBox(height: Dimensions.paddingSizeSmall,),
                                        SizedBox(width: MediaQuery.of(context).size.width/2.5,
                                            child: Text(recommended.recommendedProduct!.description??'',maxLines: 2, overflow: TextOverflow.ellipsis,
                                                style: textRegular.copyWith(fontSize: Dimensions.fontSizeLarge))),

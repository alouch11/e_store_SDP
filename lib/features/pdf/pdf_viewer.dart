...
class _PDFViewerState extends State<PDFViewer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leadingWidth: 30,
        leading: IconButton(icon:  Icon(Icons.arrow_back_ios_new_rounded, size: 18, color: Theme.of(context).textTheme.bodyLarge?.color?.withOpacity(.75),),
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: Stack(
              children: [
                  //PdfViewer.asset( 'assets/hello.pdf',
                  // PdfViewer.file(r"D:\pdfrx\example\assets\hello.pdf",

                   PdfViewer.uri(Uri.parse(widget.url),

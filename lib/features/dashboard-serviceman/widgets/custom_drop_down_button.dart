  ...
  Widget build(BuildContext context) {
    return
      ...
      return CustomDropDown(
          type: widget.title,
          hint:  widget.type=="Year"? dashboardProvider.selectedYear: selectedMonth,
          errorText: '',
          ...
          onChanged: (String? value) {
            if(widget.type=="Month"){
              ...
              dashboardProvider.changeDashboardDropdownValue(index.toString(),widget.type);
            }else if(widget.type=="Year"){
              dashboardProvider.changeDashboardDropdownValue(value!,widget.type);
            }
          }
      );
    });

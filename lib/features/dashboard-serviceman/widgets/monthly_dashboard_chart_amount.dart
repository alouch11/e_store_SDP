...
import 'package:flutter_spareparts_store/helper/responsive_helper.dart';
import 'package:get/get.dart';
import 'package:provider/provider.dart';


class MonthlyDashBoardChartAmount extends StatefulWidget {
  const MonthlyDashBoardChartAmount({super.key});

  @override
  MonthlyDashBoardChartAmountState createState() => MonthlyDashBoardChartAmountState();
}

class MonthlyDashBoardChartAmountState extends State<MonthlyDashBoardChartAmount> {
  ...
  LineChartData mainData(DashboardProvider controller) {
    return LineChartData(
      ...
      titlesData: FlTitlesData(
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              showTitles: true,
              reservedSize: 32,
              interval: controller.monthlyAmountsChartList.length==31? 3:
              controller.monthlyAmountsChartList.length==32?4:controller.monthlyAmountsChartList.length==30?3:4,
          ...
          leftTitles: AxisTitles(
              ...
              sideTitles: SideTitles(
                ...
                showTitles: true,
                reservedSize: controller.mmM1<100.00?40:controller.mmM1<10000?45:controller.mmM1<100000?50:55,
              )
      ...
      minX: 0,
      maxX: controller.monthlyAmountsChartList.length.toDouble()-1,
      minY: 0,
      maxY: controller.mmM1,
      lineBarsData: [
        LineChartBarData(

          spots:  controller.monthlyAmountsChartList,
          isCurved: false,
          curveSmoothness: 0,

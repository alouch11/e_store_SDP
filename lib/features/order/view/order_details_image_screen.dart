...
class OrderDetailsImageScreen extends StatefulWidget {
  final String? title;
  final String? imageList;
  const OrderDetailsImageScreen({super.key, required this.title, required this.imageList});

  @override
  OrderDetailsImageScreenState createState() => OrderDetailsImageScreenState();
}

class OrderDetailsImageScreenState extends State<OrderDetailsImageScreen> {
  int? pageIndex;
              ...
              PhotoViewGallery.builder(
                ...
                builder: (BuildContext context, int index) {
                  return PhotoViewGalleryPageOptions(
                    imageProvider: NetworkImage('${Provider.of<SplashProvider>(context,listen: false).baseUrls!.graphicImageUrl}/${widget.imageList}'),

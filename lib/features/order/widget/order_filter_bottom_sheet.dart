...
class OrderFilterBottomSheet extends StatefulWidget {
  ...
  @override
  OrderFilterBottomSheetState createState() => OrderFilterBottomSheetState();
}

class OrderFilterBottomSheetState extends State<OrderFilterBottomSheet> {
                              ...
                              Expanded(
                                child: CustomButton(
                                  ...
                                  onTap: () {
                                    ...
                                    searchProvider.searchProduct(query : searchProvider.searchController.text.toString(),searchtype: searchProvider.selectedType,

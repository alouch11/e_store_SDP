...
class TasksMeeting extends StatefulWidget {
  const TasksMeeting({Key? key}) : super(key: key);

  @override
  State<TasksMeeting> createState() => _TasksMeetingState();
}

class _TasksMeetingState extends State<TasksMeeting> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Container(
                                    decoration: BoxDecoration(
                                        color: TasksColor.parrot,
                                        borderRadius: BorderRadius.circular(5)
                                    ),
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(horizontal: width/36,vertical: height/120),
                                      child: Text("Urgent",style: hsMedium.copyWith(fontSize: 10,color: TasksColor.lightgreen),),
                                    )),
                                ...
                                Container(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(horizontal: width/36,vertical: height/120),
                                      child: Text("Home",style: hsMedium.copyWith(fontSize: 10,color: TasksColor.lightgreen),),
                                    )),
                              ],
                            ),
                          ],
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) {
            return TasksAddPersonal("metting");
          },));
        },

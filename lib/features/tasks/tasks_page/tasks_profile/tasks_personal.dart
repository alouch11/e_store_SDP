...
class TasksPersonal extends StatefulWidget {
  const TasksPersonal({Key? key}) : super(key: key);

  @override
  State<TasksPersonal> createState() => _TasksPersonalState();
}

class _TasksPersonalState extends State<TasksPersonal> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) {
            return TasksAddPersonal("personal");
          },));
        },

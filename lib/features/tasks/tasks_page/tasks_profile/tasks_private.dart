...
class TasksPrivate extends StatefulWidget {
  const TasksPrivate({Key? key}) : super(key: key);

  @override
  State<TasksPrivate> createState() => _TasksPrivateState();
}

class _TasksPrivateState extends State<TasksPrivate> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                            ...
                            Row(
                              children: [
                                ...
                                Container(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(horizontal: width/36,vertical: height/120),
                                      child: Text("Home",style: hsMedium.copyWith(fontSize: 10,color: TasksColor.lightred),),
                                    )),
                              ],
                            ),
                          ],
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) {
            return TasksAddPersonal("private");
          },));
        },

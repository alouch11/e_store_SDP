...
import 'package:flutter_spareparts_store/features/search/widget/search_filter_bottom_sheet.dart';
          ...
          return Column(children: [
              ...
              SingleChildScrollView(
                ...
                child: PaginatedListView(scrollController: scrollController,
                  ...
                  await searchProductProvider.searchProduct(query: searchProductProvider.searchController.text,searchtype: searchProductProvider.selectedType, offset: offset!);
                    },

...
class SaleFilterDialogByMachine extends StatefulWidget {
final bool isToggled;
final int machineId;

  const SaleFilterDialogByMachine({super.key, this.isToggled=false, required this.machineId});

  @override
  SaleFilterDialogByMachineState createState() => SaleFilterDialogByMachineState();
}

class SaleFilterDialogByMachineState extends State<SaleFilterDialogByMachine> {
                      ...
                      Padding(
                          ...
                          child: CustomButton(
                              ...
                              onTap: () {
                               ...
                               String? selectedType = saleProvider.selectedTypeByMachine;
                                  ...
                                  saleProvider.getSaleListByMachine(
                                      1, selectedType,

...
final bool isToggled;
  const SaleFilterDialog({super.key, this.isToggled=false});

  @override
  SaleFilterDialogState createState() => SaleFilterDialogState();
}

class SaleFilterDialogState extends State<SaleFilterDialog> {
                  ...
                  child: Container(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      MultiSelectBottomSheetField(
                        ...
                        items: _serviceLines,
                        //  items:  _lines!.linesmachines!.map((line) => MultiSelectItem<String>(line.lineName!, line.lineName!)).toList(),
                        onConfirm: (values) {
                      ...
                      Padding(
                          ...
                          child: CustomButton(
                              ...
                              onTap: () {
                               ...
                               String? selectedType = saleProvider.selectedType;
                                  ...
                                  saleProvider.getSaleList(
                                      ...
                                      serviceSelectedType:saleProvider.selectedServiceType
                                  );
